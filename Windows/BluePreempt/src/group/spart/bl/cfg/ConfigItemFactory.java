...
public class ConfigItemFactory {
	...
	public static void main(String[] args) {
		String cfgPath = Utils.jarPath() + "/cfg/user.cfg";
		List<ConfigItem> items = ConfigItemFactory.parse(cfgPath);
		new ConfigItemsWriter(items, Utils.jarPath() + "/cfg/test.cfg").write();
	}
